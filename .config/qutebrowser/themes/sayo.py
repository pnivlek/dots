...
# credits to leosolid/qutebrowser-themes for basing onedark off of that template which is how i found this
...
bg_default = "#2a2a2a"          # main shade darkest
bg_lighter = "#3a3a3a"
bg_selection = "#1a1a1a"
fg_disabled = "#bebebe"
fg_default = "#bebebe"
bg_lightest = "#4a4a4a"         # main shade lightest
fg_error = "#627a8a"            # red
bg_hint = "#8b8f7e"             # yellow
fg_matched_text = "#aa8f7c"     # green
bg_passthrough_mode = "#937f74" # teal
bg_insert_mode = "#987a6b"      # blue
bg_warning = "#877979"          # purple
