...
;; This file controls what Doom modules are enabled ;; This file controls what Doom modules are enabled and what order they load
;; in.;; This file controls what Doom modules are enabled and what order they load
...
(doom! :input
       ...
       (lookup           ; navigate your code and its documentation
        +dictionary)     ; words words words
       lsp               ; M-x vscode
       (magit            ; a git porcelain for Emacs
        +forge)          ; be a blacksmith
       ...
       (latex            ; writing papers in Emacs has never been so fun
        +latexmkk        ; what else would you use?
        +cdlatex         ; quick maths
...
#+begin_src emacs-lisp
(setq xdg-directory-documents "/home/yack/doc")
#+end_src
...
** Fonts
#+begin_src emacs-lisp
;; (setq doom-font (font-spec :family "M PLUS Code Latin 50" :style "Regular" :size 13)
(setq doom-font (font-spec :family "PragmataPro for Powerline" :style "Regular" :size 13)
      ...
      ;; doom-serif-font (font-spec :family "M PLUS Code Latin 50" :weight 'light :size 13))
      doom-serif-font (font-spec :family "PragmataPro for Powerline" :weight 'light :size 13))
#+end_src
...
(setq ispell-personal-dictionary (expand-file-name ".ispell_personal" xdg-directory-documents))
#+end_src
